适用于 OpenWrt 24.10(下载ipk.zip安装) / OpenWrt 25.12(下载apk.zip安装) 的 HomeProxy LuCI 管理界面，按 `官方内核sing-box 1.13.21` 进行二次定制适配，在官方内核基础上增加功能：  
1、远程规则集本地持久化  
2、Clash API 代理供应商  
3、Clash API 中文名称
...
weicaixian86
https://github.com/weicaixian86/luci-app-homeproxy
